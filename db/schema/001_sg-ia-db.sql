...
-- Versión: 2.2 (Feedback Predefinido + Gestión de Batches)
-- =========================================================
...
-- =========================================================
-- Esta tabla organiza las preguntas por su origen: generadas por IA, importadas de CSV, etc.
-- Permite al admin ver "Lote IA-Diciembre: 30 preguntas, 25 verificadas"
...
-- =========================================================
-- 4. EXPLICACIONES (Ahora diferenciadas por tipo de respuesta)
-- =========================================================
-- Cada pregunta puede tener DOS explicaciones:
-- - Una para cuando el jugador responde CORRECTAMENTE
-- - Una para cuando responde INCORRECTAMENTE
-- Ejemplo: Pregunta ID 5
--   - question_explanations(id=15, question_id=5, type='correct', text='Correcto porque...')
--   - question_explanations(id=16, question_id=5, type='incorrect', text='Incorrecto porque...')
...
-- Vista para administrador: preguntas pendientes de verificar
...
-- Vista para administrador: estadísticas de batches
...
JSON VÁLIDO ESTRICTO (sin markdown):', 0.7, 1
);
